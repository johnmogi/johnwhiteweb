...
<main>
    <div class="ptsd_section">
        <h2 class="ptsd_title"><?php the_field('title_ptsd'); ?></h2>
            ...
            <div class="about_me_ptsd">
                <div>
                    <img  class= "img_ptsd" style="width: 646px; height: 646px;" src="<?php echo get_field('image_left_ptsd'); ?>" alt="<?php echo get_field('image_left_ptsd'); ?>">
                </div>
